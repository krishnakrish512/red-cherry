...
//                var_dump($image);
        ...
        <ul class="style-none cart-product-list">
            <li class="d-flex align-items-center selected-item">
                <a href="<?= $product_permalink ?>" class="item-img d-flex align-items-center justify-content-center">
                    <img src="<?= $image; ?>" alt="<?= $_product->get_name() ?>">
                </a>
                <div class="item-info">
                    <a href="<?= $product_permalink ?>" class="name"><?= $product_name ?></a>
                    <div class="price">
...
<div class="subtotal d-flex justify-content-between align-items-center">
    ...
    <div class="total-price"><?= WC()->cart->get_cart_subtotal() ?></div>
</div>
...
<ul class="style-none button-group">
    <li><a href="<?= wc_get_cart_url() ?>" class="view-cart">View Cart</a></li>
    <li><a href="<?= wc_get_checkout_url() ?>" class="checkout">Checkout</a></li>
</ul>
